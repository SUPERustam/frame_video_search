from cv2.img_hash import RadialVarianceHash
...
class RadialVarianceframeHasher(AbstractFrameHasher):
    def __init__(self) -> None:
        super().__init__(name="RadialVariance")
        self.hasher = RadialVarianceHash.create()
        self.vector_size = 40
